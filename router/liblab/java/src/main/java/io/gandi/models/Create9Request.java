...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create9Request.Builder.class)
public class Create9Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create9Request buildWithoutValidation() {
      return new Create9Request(this);
    }
  ...
  Create9Request(Builder builder) {
    super(builder);
