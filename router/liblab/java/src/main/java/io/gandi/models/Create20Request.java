...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create20Request.Builder.class)
public class Create20Request extends io.gandi.models.BaseModel {

  @lombok.Getter
  @lombok.EqualsAndHashCode(callSuper = false)
  @lombok.ToString
  @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
  @com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create20Request.Data.Builder.class)
  public static class Data extends io.gandi.models.BaseModel {
    ...
    public static class Builder extends io.gandi.models.BaseModel.Builder {
      ...
      public Create20Request.Data build() {
      ...
      public Create20Request.Data buildWithoutValidation() {
        return new Create20Request.Data(this);
      }
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    private Create20Request.Data data;
    ...
    public Create20Request buildWithoutValidation() {
      return new Create20Request(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("data")
  private final Create20Request.Data data;
  ...
  Create20Request(Builder builder) {
    super(builder);
