...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create14Request.Builder.class)
public class Create14Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create14Request buildWithoutValidation() {
      return new Create14Request(this);
    }
  ...
  Create14Request(Builder builder) {
    super(builder);
