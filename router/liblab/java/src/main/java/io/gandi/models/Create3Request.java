...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create3Request.Builder.class)
public class Create3Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create3Request buildWithoutValidation() {
      return new Create3Request(this);
    }
  ...
  Create3Request(Builder builder) {
    super(builder);
