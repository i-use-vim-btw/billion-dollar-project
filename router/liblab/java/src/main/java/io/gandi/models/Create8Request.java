...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create8Request.Builder.class)
public class Create8Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create8Request buildWithoutValidation() {
      return new Create8Request(this);
    }
  ...
  Create8Request(Builder builder) {
    super(builder);
