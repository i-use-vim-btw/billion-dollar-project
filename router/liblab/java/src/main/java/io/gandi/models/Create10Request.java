...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create10Request.Builder.class)
public class Create10Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] {
        new java.lang.String[] { "collectionName", "newCollectionName" },
      };
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("newCollectionName")
    private java.lang.String newCollectionName;
    ...
    public Create10Request buildWithoutValidation() {
      return new Create10Request(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("newCollectionName")
  private final java.lang.String newCollectionName;

  Create10Request(Builder builder) {
    super(builder);
    this.collectionName = builder.getCollectionName();
    this.dbName = builder.getDbName();
    this.newCollectionName = builder.getNewCollectionName();
  }
}
