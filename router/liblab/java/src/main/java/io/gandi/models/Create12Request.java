...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create12Request.Builder.class)
public class Create12Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] {
        new java.lang.String[] { "collectionName", "indexName" },
      };
    ...
    public Create12Request buildWithoutValidation() {
      return new Create12Request(this);
    }
  ...
  Create12Request(Builder builder) {
    super(builder);
