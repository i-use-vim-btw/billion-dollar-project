...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create13Request.Builder.class)
public class Create13Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create13Request buildWithoutValidation() {
      return new Create13Request(this);
    }
  ...
  Create13Request(Builder builder) {
    super(builder);
