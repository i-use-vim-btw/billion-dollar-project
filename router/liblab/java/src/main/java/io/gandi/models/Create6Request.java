...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create6Request.Builder.class)
public class Create6Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create6Request buildWithoutValidation() {
      return new Create6Request(this);
    }
  ...
  Create6Request(Builder builder) {
    super(builder);
