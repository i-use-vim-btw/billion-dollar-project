...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create7Request.Builder.class)
public class Create7Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] { new java.lang.String[] { "dbName" } };
    ...
    public Create7Request buildWithoutValidation() {
      return new Create7Request(this);
    }
  ...
  Create7Request(Builder builder) {
    super(builder);
