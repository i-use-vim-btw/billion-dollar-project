...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create5Request.Builder.class)
public class Create5Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create5Request buildWithoutValidation() {
      return new Create5Request(this);
    }
  ...
  Create5Request(Builder builder) {
    super(builder);
