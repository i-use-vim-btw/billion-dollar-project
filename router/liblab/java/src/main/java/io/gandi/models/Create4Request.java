...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create4Request.Builder.class)
public class Create4Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    private java.lang.String partitionNames;
    ...
    public Create4Request buildWithoutValidation() {
      return new Create4Request(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("partitionNames")
  private final java.lang.String partitionNames;

  Create4Request(Builder builder) {
    super(builder);
