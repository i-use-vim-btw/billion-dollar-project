...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create15Request.Builder.class)
public class Create15Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    public Create15Request buildWithoutValidation() {
      return new Create15Request(this);
    }
  ...
  Create15Request(Builder builder) {
    super(builder);
