...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Create18Request.Builder.class)
public class Create18Request extends io.gandi.models.BaseModel {
  ...
  public static class Builder extends io.gandi.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] {
        new java.lang.String[] { "collectionName", "filter" },
      };
    ...
    public Create18Request buildWithoutValidation() {
      return new Create18Request(this);
    }
  ...
  Create18Request(Builder builder) {
    super(builder);
