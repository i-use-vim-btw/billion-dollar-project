...
class VectorsSearchPostRequestSearchParams(BaseModel):
    """
    VectorsSearchPostRequestSearchParams
    """ # noqa: E501
    metric_type: Optional[StrictStr] = Field(default=None, alias="metricType")
    params: Optional[VectorsSearchPostRequestSearchParamsParams] = None
    __properties: ClassVar[List[str]] = ["metricType", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": VectorsSearchPostRequestSearchParamsParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
