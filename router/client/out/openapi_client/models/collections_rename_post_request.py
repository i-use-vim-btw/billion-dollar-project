...
class CollectionsRenamePostRequest(BaseModel):
    """
    ...
    new_collection_name: StrictStr = Field(alias="newCollectionName")
    __properties: ClassVar[List[str]] = ["dbName", "collectionName", "newCollectionName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newCollectionName": obj.get("newCollectionName")
        })
        return _obj
