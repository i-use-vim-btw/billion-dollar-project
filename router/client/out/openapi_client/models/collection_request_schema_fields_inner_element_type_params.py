...
class CollectionRequestSchemaFieldsInnerElementTypeParams(BaseModel):
    """
    CollectionRequestSchemaFieldsInnerElementTypeParams
    """ # noqa: E501
    max_length: Optional[StrictInt] = None
    dim: Optional[StrictInt] = None
    max_capacity: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["max_length", "dim", "max_capacity"]
