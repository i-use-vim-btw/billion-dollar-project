...
class VectorsSearchPostRequestSearchParamsParams(BaseModel):
    """
    VectorsSearchPostRequestSearchParamsParams
    """ # noqa: E501
    radius: Optional[StrictInt] = None
    range_filter: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["radius", "range_filter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "range_filter": obj.get("range_filter")
        })
        return _obj
