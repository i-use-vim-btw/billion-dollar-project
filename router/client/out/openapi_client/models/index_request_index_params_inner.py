...
class IndexRequestIndexParamsInner(BaseModel):
    """
    ...
    params: Optional[IndexRequestIndexParamsInnerParams] = None
    __properties: ClassVar[List[str]] = ["metricType", "fieldName", "indexName", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": IndexRequestIndexParamsInnerParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
