...
VECTORSINSERTPOSTREQUESTDATAVALUE_ANY_OF_SCHEMAS = ["List[bool]", "List[float]", "List[int]", "List[str]", "bool", "float", "int", "str"]

class VectorsInsertPostRequestDataValue(BaseModel):
    """
    VectorsInsertPostRequestDataValue
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = VectorsInsertPostRequestDataValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in VectorsInsertPostRequestDataValue with anyOf schemas: List[bool], List[float], List[int], List[str], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into VectorsInsertPostRequestDataValue with anyOf schemas: List[bool], List[float], List[int], List[str], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
