...
class CollectionsGetLoadStatePostRequest(BaseModel):
    """
    ...
    partition_names: Optional[StrictStr] = Field(default=None, alias="partitionNames")
    __properties: ClassVar[List[str]] = ["dbName", "collectionName", "partitionNames"]
